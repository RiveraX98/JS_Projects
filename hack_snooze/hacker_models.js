...
class Story {
  ...
  constructor({ storyId, author,title, url, username, createdAt }) {
...
class StoryList {
  ...
  async addStory (user, {author,title, url} ) {
    ...
    const res = await axios({
      ...
      return new Story( storyId, author,title, url, username, createdAt )
...
class User {
  ...
  async handleFavorite(state, story) {
  ...
  async addFavorite(story) {
    ...
    await this.handleFavorite("add", story)
  }
  async removeFavorite(story) {
    this.favorites = this.favorites.filter(s => s.storyId !== story.storyId);
    await this.handleFavorite("remove", story);
  }
  isFavorite(story) {
